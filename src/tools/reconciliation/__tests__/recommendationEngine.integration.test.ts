...
2024-03-15,Netflix,15.99`;
			...
			const repeatInsight = analysis.insights.find(
				(insight) => insight.type === "repeat_amount",
			);
...
2024-01-17,Gas Station,45.00`;
			...
			const actionTypes = new Set(
				analysis.recommendations?.map((rec) => rec.action_type),
			);
...
2024-01-17,Large Transaction C,1000.00`;
			...
			const anomalyInsight = analysis.insights.find(
