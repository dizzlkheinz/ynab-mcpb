...
describeIntegration("YNABMCPServer", () => {
	...
	describe("Real YNAB API Integration", () => {
		...
		it("should successfully validate real YNAB token", {
		...
		it("should successfully get user information", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
		...
		it("should successfully get budgets", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
				const ynabAPI = server.getYNABAPI();
		...
		it("should successfully start and connect MCP server", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
		...
		it("should handle multiple rapid API calls without rate limiting issues", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
	...
	describe("MCP Server Functionality", () => {
		...
		it("should execute get_user tool via the registry", {
			meta: { tier: "core", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
		...
		it("should set and retrieve default budget using tools", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
		...
		it("should provide diagnostic info with requested sections", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
		...
		it("should clear cache using the clear_cache tool", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
		...
		it("should track cache performance metrics during real tool execution", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
		...
		it("should demonstrate LRU eviction with real cache operations", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
		...
		it("should show cache hit rate improvement with repeated operations", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
			cacheManager.clear();
		...
		it("should handle concurrent cache operations correctly", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
			cacheManager.clear();
		...
		it("should include enhanced cache metrics in real diagnostic collection", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
		...
		it("should surface validation errors for invalid inputs", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
			const result = await registry.executeTool({
	...
	describe("Modular Architecture Integration with Real API", () => {
		...
		it("should maintain real API functionality after modular refactoring", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
		...
		it("should handle modular service errors gracefully in integration", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
	...
	describe("Budget Resolution Integration Tests", () => {
		...
		it("should handle real YNAB API calls with budget resolution errors", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
		...
		it("should handle real YNAB API calls with invalid budget ID", {
			meta: { tier: "domain", domain: "server" },
		}, async () => {
		...
		it("should complete end-to-end workflow with real YNAB API after setting default budget", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
		...
		it("should handle real API errors properly with budget resolution", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
		...
		it("should maintain performance with real API calls and budget resolution", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
				const budgetId = await getFirstAvailableBudgetId();
		...
		it("should handle security middleware with budget resolution errors", {
			meta: { tier: "domain", domain: "server" },
		}, async (ctx) => {
			await skipOnRateLimit(async () => {
